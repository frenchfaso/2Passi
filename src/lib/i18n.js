const STRINGS = {
  it: {
    ...
    settings: {
      ...
      clearOffline: "Cancella tile in cache",
      clearOfflineConfirm: "Cancellare tutti i tile della mappa in cache?",
      clearing: "Cancellazione tile in cache…",
      cleared: "Tile in cache cancellati.",
  ...
  en: {
    ...
    settings: {
      ...
      clearOffline: "Clear cached tiles",
      clearOfflineConfirm: "Clear all cached map tiles?",
      clearing: "Clearing cached tiles…",
      cleared: "Cached tiles cleared.",
      clearFailed: "Failed to clear cached tiles.",
  ...
  de: {
    ...
    settings: {
      ...
      clearOffline: "Zwischengespeicherte Tiles löschen",
      clearOfflineConfirm: "Alle zwischengespeicherten Karten-Tiles löschen?",
      clearing: "Zwischengespeicherte Tiles werden gelöscht…",
      cleared: "Zwischengespeicherte Tiles gelöscht.",
      clearFailed: "Zwischengespeicherte Tiles konnten nicht gelöscht werden.",
